...
##             submitted            finished
## 1 2014-01-08 15:59:20 2014-01-08 16:05:06
## 2 2014-01-08 15:59:20 2014-01-08 16:05:06
##                                                                                                                                       command
...
## ...
##             submitted            finished
## 7 2014-01-08 16:05:06 2014-01-08 16:09:59
## 8 2014-01-08 16:09:59 2014-01-08 16:10:05
##                                                                       command
...
## '/media/D/expression/GAP_Expression/final_reports_genomestudio/pheno_info.txt':
...
```
## Error: object 'pheno_dat' not found
```
...
```
## Error: object 'has_pheno_cols' not found
```
...
```
## Error: object 'missing_pheno_cols' not found
```
...
## 3. check pData(), sample & batch info Sample.ID's match in names and numbers

```r
# check they all match
raw_n_samples == raw_n_pheno_dat
```

```
## Error: object 'raw_n_pheno_dat' not found
```
