...
This is all based on my experience, but I can guarantee that following the steps in this workflow will give you clean and robust data, and will also help identify and problems you may have with your data. *You will be surprised at some of the things your Omic's data will reveal....*
...
# HOW TO GET THE WORKFLOW SCRIPTS....This works...
...
pdf(file=paste(out_dir,"/",project_name,".eset_raw.coloured_dendrogram_lumi.pdf",sep=""),width=7,height=7)
...
Samples with XIST probe expression greater than or equal to the mean negative bead expression are flagged as FEMALE.
