...
library(markdown)
library(shiny)
opts_chunk$set(error=FALSE, tidy=TRUE, warning=FALSE, highlight=TRUE, cache=TRUE)
...
## 8. QC plots on eset_raw

### basic_qc_plot_lumi
```{r basic_qc_plot_lumi_eset_raw, fig.height=7, fig.width=10, out.width=14, out.height=7, dpi=300  ,eval=TRUE}
# basic plots
dev.off()
...
```{r coloured_dendrogram_lumi_eset_raw, fig.height=7, fig.width=10, out.width=14, out.height=7, dpi=300  ,eval=TRUE}}
# coloured_dendrogram_lumi
dev.off()
...
### pca_plot_lumi
```{r pca_plot_lumi_eset_raw, fig.height=7, fig.width=7, out.width=7, out.height=7, dpi=300  ,eval=TRUE}
# PCA plots
dev.off()
...
### SampleNetwork Plots
```{r sampleNetwork_plot_all_lumi_eset_raw, fig.height=10, fig.width=10, out.width=7, out.height=7, dpi=300  ,eval=TRUE}
# SampleNetwork Plots
dev.off()
...
## 4. basic_qc_plot_lumi eset_bg
```{r basic_qc_plot_lumi_eset_bg, fig.height=7, fig.width=10, out.width=14, out.height=7, dpi=300  ,eval=TRUE}
# basic plots
dev.off()
...
## 5. coloured_dendrogram_lumi eset_bg
```{r coloured_dendrogram_lumi_eset_bg, fig.height=7, fig.width=10, out.width=14, out.height=7, dpi=300  ,eval=TRUE}}
# coloured_dendrogram_lumi
dev.off()
...
## 6. pca_plot_lumi eset_bg
```{r pca_plot_lumi_eset_bg, fig.height=7, fig.width=7, out.width=7, out.height=7, dpi=300  ,eval=TRUE}
# PCA plots
dev.off()
...
## 7. SampleNetwork Plots eset_bg
```{r sampleNetwork_plot_all_lumi_eset_bg, fig.height=10, fig.width=10, out.width=7, out.height=7, dpi=300  ,eval=TRUE}
# SampleNetwork Plots
dev.off()
...
```{r checkGender, fig.height=7, fig.width=7, out.width=7, out.height=7, dpi=300, eval=TRUE}
...
==============================
Here we are creating lists of probes that have expression levels >= of the mean intensity of the negative control beads.  
...
#############################################################################################
## THIS IS THE MAIN PROBE DETECTION CALCULATION
## loop through each group and id probes >  mean neg beads in X% of samples/group
#############################################################################################

for(n in group_names ) {
cat(" Finding probes in ",probe_det/100," of sample group [",n,"] with signal intensity > mean intensity of the negative control beads ","\r","\n")
...
cat(" Number of probes in group [",n,"] with signal intensity > mean intensity of the negative control beads = ", length(group_probe_detecti                                                                                                                     on_nuID) ,"\r","\n")
...
## 4. basic_qc_plot_lumi eset_bg_log2_rsn_0 pre-sample removal
```{r basic_qc_plot_lumi_eset_bg_log2_rsn_0, fig.height=7, fig.width=10, out.width=14, out.height=7, dpi=300  ,eval=TRUE}
# basic plots
dev.off()
...
## 5. coloured_dendrogram_lumi eset_bg_log2_rsn_0 pre-sample removal
```{r coloured_dendrogram_lumi_eset_bg_log2_rsn_0, fig.height=7, fig.width=10, out.width=14, out.height=7, dpi=300  ,eval=TRUE}}
# coloured_dendrogram_lumi
dev.off()
...
## 6. pca_plot_lumi eset_bg_log2_rsn_0 pre-sample removal
```{r pca_plot_lumi_eset_bg_log2_rsn_0, fig.height=7, fig.width=7, out.width=7, out.height=7, dpi=300  ,eval=TRUE}
# PCA plots
dev.off()
...
## 7. SampleNetwork Plots eset_bg_log2_rsn_0 pre-sample removal
```{r sampleNetwork_plot_all_lumi_eset_bg_log2_rsn_0, fig.height=10, fig.width=10, out.width=7, out.height=7, dpi=300  ,eval=TRUE}
# SampleNetwork Plots
dev.off()
...
SampleNetWork_outliers$Study_ID
...
```{r basic_qc_plot_lumi_eset_bg_log2_rsn, fig.height=7, fig.width=10, out.width=14, out.height=7, dpi=300  ,eval=TRUE}
# basic plots
dev.off()
...
```{r coloured_dendrogram_lumi_eset_bg_log2_rsn, fig.height=7, fig.width=10, out.width=14, out.height=7, dpi=300  ,eval=TRUE}}
# coloured_dendrogram_lumi
dev.off()
...
```{r pca_plot_lumi_eset_bg_log2_rsn, fig.height=7, fig.width=7, out.width=7, out.height=7, dpi=300  ,eval=TRUE}
# PCA plots
dev.off()
...
```{r sampleNetwork_plot_all_lumi_eset_bg_log2_rsn, fig.height=10, fig.width=10, out.width=7, out.height=7, dpi=300  ,eval=TRUE}
# SampleNetwork Plots
dev.off()
...
=====================================
```{r linear_model_batch_correction, eval=FALSE}
...
for(probe in probe_names){
    ...
    sink(file=paste(out_dir,"/",project_name,".lm_probe_progress_rsq.txt",sep=""))
...
gx_qc_plots_lumi(eset=eset_final, outfile=paste(out_dir,"/",project_name,".eset_final",sep="") )
...
project_summary <- data.frame(
  ...
  n_good_samples=n_good_probes,
  n_unique_study_id_good_samples=n_unique_study_id_good_samples,

  
  
  raw_RData=paste(out_dir,"/",project_name,".eset_raw.RData",sep=""),
  bg_corrected_RData=paste(out_dir,"/",project_name,".eset_bg.RData",sep=""),
  bg_log2_rsn_0_RData=paste(out_dir,"/",project_name,".eset_bg_log2_rsn_0.RData",sep=""),
  bg_log2_rsn_RData=paste(out_dir,"/",project_name,".eset_bg_log2_rsn.RData",sep=""),
  bg_log2_rsn_adjusted_RData=paste(out_dir,"/",project_name,".eset_bg_log2_rsn_adj.RData",sep=""),
  final_RData=paste(out_dir,"/",project_name,".eset_final.RData",sep="")
...
# XIST
system( paste(" mv *.XIST* ",out_dir,"/XIST/",sep=""))

# detected probes
system( paste(" mv *.detected_probes* ",out_dir,"/detected_probes/",sep=""))

# SampleNetwork
system( paste(" mv *ampleNetwork* ",out_dir,"/SampleNetwork/",sep=""))

# batch regressions multivariate
system( paste(" mv *multivariate* ",out_dir,"/batch_regressions/",sep=""))

# eset_****
system( paste(" mv *.eset_raw* ",out_dir,"/eset_raw/",sep=""))
system( paste(" mv *.eset_bg* ",out_dir,"/eset_bg/",sep=""))
system( paste(" mv *.eset_bg_log2_rsn* ",out_dir,"/eset_bg_log2_rsn/",sep=""))
system( paste(" mv *.eset_final* ",out_dir,"/eset_final/",sep=""))
...
NOT RUN!
### Heatmaps
```{r heatmap_plot_lumi_eset_raw, fig.height=10, fig.width=10, out.width=7, out.height=7, dpi=300, eval=FALSE}
# Heatmaps
